...
const Auth = () => {
  ...
  const [userRegistration, setuserRegistration] = useState({
    ...
    const handleSubmit = async (e) =>{
      ...
      const res = await fetch("http://flipr-hackathon1.onrender.com/login", {
        method: "POST",
        headers: {
              ...
              <div className="card-body px-4 py-5 px-md-5">
                <form action='submit'>
                  <div className="form-outline mb-4">
                    ...
                    <input type="text" autoComplete='off' id="form3Example3" className="form-control" onChange={handleInput} name="email" value={userRegistration.email}/>
                  </div>
                  <div className="form-outline mb-4">
